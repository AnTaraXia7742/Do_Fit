...
<section class="orders">
   ...
   <?php
      if($user_id == ''){
         echo '<p class="empty">Login terlebih dahulu agar bisa melihat pesanan!</p>';
      }else{
   ...
   <div class="box">
      ...
      <p>total bayar : <span>IDR<?= $fetch_orders['total_price']; ?>/-</span></p>
   ...
   <?php
         ...
         echo '<p class="empty">belum menerima pesanan!</p>';
      }
      }
   ?>
